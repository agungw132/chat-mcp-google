...
SYSTEM_INSTRUCTION = (
    ...
    "You can access Gmail, Calendar, Contacts, and Drive using the available tools. "
    ...
    "Do not use Gmail/Drive/Contacts tools to search public place addresses. "
    "If user asks to find an address on the public web/maps, skip address lookup and continue with available data."
)

OPENAI_SYSTEM_INSTRUCTION = (
    "You are a helpful AI assistant. Respond in English. "
    "You can access Gmail, Google Calendar, Google Contacts, and Google Drive using the available tools. "
    "Use tools only when needed and only if relevant to the user request. "
